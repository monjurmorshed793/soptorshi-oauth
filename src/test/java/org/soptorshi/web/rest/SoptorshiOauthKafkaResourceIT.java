...
import org.soptorshi.SoptorshiOauthApp;
...
@SpringBootTest(classes = SoptorshiOauthApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class SoptorshiOauthKafkaResourceIT {
    ...
    @Autowired
    private SoptorshiOauthKafkaProducer producer;

    @Autowired
    private SoptorshiOauthKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        SoptorshiOauthKafkaResource kafkaResource = new SoptorshiOauthKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/soptorshi-oauth-kafka/publish?message=test"))
